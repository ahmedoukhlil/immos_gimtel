...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2809082333-0', 'filter-designation');
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2809082333-1', 'localisation-select-static');
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2809082333-2', 'affectation-select-' . ($filterLocalisation ?? 'none'));
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-2809082333-3', 'emplacement-select-' . ($filterLocalisation ?? 'none') . '-' . ($filterAffectation ?? 'none'));
...
?>
                        ...
                        <div class="mt-3 pt-3 border-t border-gray-200">
                            <form
                                action="<?php echo e(route('biens.imprimer-etiquettes-tous-emplacements')); ?>"
                                method="POST"
                                class="inline-block">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="filterLocalisation" value="<?php echo e($filterLocalisation); ?>">
                                <input type="hidden" name="filterAffectation" value="<?php echo e($filterAffectation); ?>">
                                <button
                                    type="submit"
                    ...
                    <div class="bg-gray-50 border border-gray-200 rounded-lg p-4">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($filterNumOrdreMin !== '' && $filterNumOrdreMax !== ''): ?>
                            <div class="mt-3 pt-3 border-t border-gray-200">
                                <form
                                    action="<?php echo e(route('biens.imprimer-etiquettes-par-intervalle')); ?>"
                                    method="POST"
                                    class="inline-block">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="numOrdreMin" value="<?php echo e($filterNumOrdreMin); ?>">
                                    <input type="hidden" name="numOrdreMax" value="<?php echo e($filterNumOrdreMax); ?>">
                                    <button
                                        type="submit"
                                        class="inline-flex items-center justify-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-lg transition-colors shadow-sm"
                            ...
                            <tr>
                                <td colspan="9" class="px-4 py-12 text-center">
                                    ...
                                    <p class="mt-1 text-sm text-gray-500">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($search || $filterDesignation || $filterCategorie || $filterLocalisation || $filterAffectation || $filterEmplacement || $filterNumOrdreMin || $filterNumOrdreMax || $filterDateAcquisition): ?>
...
<?php /**PATH C:\xampp\htdocs\immos_gimtel\resources\views/livewire/biens/liste-biens.blade.php ENDPATH**/ ?>